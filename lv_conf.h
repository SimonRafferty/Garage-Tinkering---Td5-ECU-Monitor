...
#define LV_FONT_MONTSERRAT_16 1  // Enabled for gauge name
#define LV_FONT_MONTSERRAT_18 0
#define LV_FONT_MONTSERRAT_20 0
#define LV_FONT_MONTSERRAT_22 1  // Enabled for gauge units
...
#define LV_USE_SYSMON   1
    ...
    #define LV_USE_PERF_MONITOR 0  // Disabled - conflicts with gauge labels
